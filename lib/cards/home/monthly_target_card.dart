...
class MonthlyTargetCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isLoading = ref.watch(homeMonthlyTargetLoadingProvider);
    final monthlyTargetError = ref.watch(homeMonthlyTargetErrorProvider);
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (monthlyTargetError != null &&
                    monthlyTargetError.isNotEmpty) ...[
                  const SizedBox(height: AppSpacing.sm),
                  Text(
                    monthlyTargetError,
