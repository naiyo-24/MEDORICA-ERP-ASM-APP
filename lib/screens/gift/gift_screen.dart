...
class _GiftScreenState extends ConsumerState<GiftScreen> {
	...
	Widget build(BuildContext context) {
		...
		final filteredApps = applications.where((app) {
			final doctorMatch = _selectedDoctorId == null || _selectedDoctorId!.isEmpty || app.doctorId == _selectedDoctorId;
			final statusMatch = (_selectedStatus == null || _selectedStatus!.isEmpty) || app.status == _selectedStatus;
		...
		return Scaffold(
			appBar: AppBar(
				...
				title: const Text('Gift Requests'),
				bottom: PreferredSize(
					preferredSize: const Size.fromHeight(32),
					child: Padding(
						padding: const EdgeInsets.only(bottom: 8.0),
						child: Text(
							'Manage and request gifts for doctors',
										...
										onDelete: () async {
											final confirm = await showDialog<bool>(
												...
												builder: (ctx) => AlertDialog(
													...
													content: const Text('Are you sure you want to delete this gift request?'),
													actions: [
														TextButton(
